...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/dwerlich/projetos/citi-dash/api/public/storage' => 'string',
            'jwt.secret' => 'NULL',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/dwerlich/projetos/citi-dash/api/public/storage','jwt.secret','jwt.keys.public',
...
'users.store','users.show','users.update','users.destroy','tenants.index',
'tenants.store','tenants.show','tenants.update','tenants.destroy','storage.local',);
...
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL','LOG_CHANNEL','DB_CONNECTION','DB_HOST','DB_PORT',
...
'MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','BROADCAST_CONNECTION','FILESYSTEM_DISK',
'QUEUE_CONNECTION','PUSHER_APP_ID','PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_APP_CLUSTER',
'MIX_PUSHER_APP_KEY','MIX_PUSHER_APP_CLUSTER','SEND_MESSAGES_LOCAL',);
