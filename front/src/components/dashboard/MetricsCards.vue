    ...
    >
      ...
      >
        <b-card-header class="border-0 d-flex align-items-center">
          <h6 class="card-title text-uppercase fw-semibold text-muted mb-0 flex-grow-1">
            Total de Metas
          </h6>
          <span class="text-primary fs-12">
            <i class="ri-arrow-right-up-line align-middle" />
          ...
          <div class="d-flex align-items-end justify-content-between">
            ...
            <div class="avatar-sm flex-shrink-0">
              <span class="avatar-title bg-primary-subtle rounded fs-3">
                <i class="ri-focus-3-line text-primary" />
              </span>
            </div>
          </div>
        </b-card-body>
          ...
          <div class="d-flex align-items-end justify-content-between">
            <div>
              ...
              <span class="badge bg-success-subtle text-success">
                <i class="ri-checkbox-circle-line align-middle me-1" />
                Finalizadas
              </span>
            </div>
            <div class="avatar-sm flex-shrink-0">
      ...
      >
        <b-card-header class="border-0 d-flex align-items-center">
          ...
          <span class="text-info fs-12">
            <i class="ri-time-line align-middle" />
          ...
          <div class="d-flex align-items-end justify-content-between">
            <div>
              ...
              <span class="badge bg-info-subtle text-info">
                <i class="ri-loader-4-line align-middle me-1" />
                Ativas
              </span>
            </div>
            <div class="avatar-sm flex-shrink-0">
              <span class="avatar-title bg-info-subtle rounded fs-3">
                <i class="ri-loader-4-line text-info" />
              </span>
            </div>
          </div>
        </b-card-body>
      ...
      >
        <b-card-header class="border-0 d-flex align-items-center">
          ...
          <span class="text-danger fs-12">
            <i class="ri-arrow-right-down-line align-middle" />
            Urgente
          </span>
        </b-card-header>
        <b-card-body class="pt-0">
          <div class="d-flex align-items-end justify-content-between">
            <div>
              ...
              <span class="badge bg-danger-subtle text-danger">
                <i class="ri-alarm-warning-line align-middle me-1" />
                Requer atenção
              </span>
            </div>
            <div class="avatar-sm flex-shrink-0">
              <span class="avatar-title bg-danger-subtle rounded fs-3">
                <i class="ri-alarm-warning-line text-danger" />
              </span>
            </div>
          </div>
        </b-card-body>
      ...
      >
        <b-card-header class="border-0 d-flex align-items-center">
          ...
          <span class="text-warning fs-12">
            <i class="ri-bar-chart-box-line align-middle" />
            Média
          </span>
        </b-card-header>
        <b-card-body class="pt-0">
          <div class="d-flex align-items-end justify-content-between">
            ...
            <div class="avatar-sm flex-shrink-0">
              <span class="avatar-title bg-warning-subtle rounded fs-3">
                <i class="ri-percent-line text-warning" />
              </span>
            </div>
          </div>
        </b-card-body>
      ...
      >
        <b-card-header class="border-0 d-flex align-items-center">
          ...
          <span class="text-muted fs-12">
            <i class="ri-close-circle-line align-middle" />
            Total
          </span>
        </b-card-header>
        <b-card-body class="pt-0">
          <div class="d-flex align-items-end justify-content-between">
            <div>
              ...
              <span class="badge bg-light text-muted">
                <i class="ri-close-circle-line align-middle me-1" />
                Metas canceladas
              </span>
            </div>
            <div class="avatar-sm flex-shrink-0">
              <span class="avatar-title bg-light rounded fs-3">
                <i class="ri-close-circle-line text-muted" />
              </span>
            </div>
          </div>
        </b-card-body>
