  ...
  >
    <b-card-header class="align-items-center d-flex border-0">
      <h6 class="card-title mb-0 flex-grow-1">
        <i class="ri-trophy-line align-middle me-1 text-warning" />
        Ranking
      </h6>
    </b-card-header>
    <b-card-body class="pt-0">
      ...
      >
        <table class="table table-borderless table-sm align-middle mb-0">
          <tbody>
            <tr
              v-for="(performer, index) in performers.slice(0, 8)"
              :key="performer.id"
            >
              <td style="width: 50px;">
                <div class="d-flex align-items-center justify-content-center">
                  <i :class="[getMedalIcon(index), getMedalClass(index), 'fs-4']" />
                </div>
              </td>
              <td>
      ...
      >
        ...
        >
          Ver relatorio completo <i class="ri-arrow-right-s-line align-middle" />
        </router-link>
      </div>
    </b-card-body>
  </b-card>
